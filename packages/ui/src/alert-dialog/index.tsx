...
import * as S from './alert-dialog.styles'
    ...
    <BaseAlertDialog.Root>
      ...
      <BaseAlertDialog.Portal>
        ...
        <S.Popup className={className}>
          ...
          <S.Actions>
            <S.Cancel onClick={onCancel}>{cancelLabel}</S.Cancel>
            <S.Confirm $destructive={destructive} onClick={onConfirm}>
              {confirmLabel}
            </S.Confirm>
          </S.Actions>
        </S.Popup>
...
function Backdrop({
  ...
  return <S.Backdrop className={className} {...props} />
}
...
function Title({
  ...
  return <S.Title className={className} {...props} />
}
...
function Description({
  ...
  return <S.Description className={className} {...props} />
}
